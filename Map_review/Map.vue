      ...
      <template #body>
        <div class="map-body">
          ...
          <table>
            <tr>
              <th>리뷰 : </th>
              <td><a v-bind:href="n_Review" onclick="window.open(this.href); return false;">네이버</a>  |  
                  <a v-bind:href="k_Review" onclick="window.open(this.href); return false;">카카오</a>  |  
                  <a v-bind:href="g_Review" onclick="window.open(this.href); return false;">구글</a>
              </td>
            </tr>
          </table>
        </div>
...
export default {
  ...
  methods:{
    openModal(idx, list, ci){
      ...
      //modalReview 추가
      this.n_Review = restaurantInfo[idx].n_review
      this.k_Review = restaurantInfo[idx].k_review
      this.g_Review = restaurantInfo[idx].g_review
