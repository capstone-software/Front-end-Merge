...
const config = {
  ...
  // 위생등급 지정현황
  hygieneGrade: 'http://openapi.foodsafetykorea.go.kr/api/' + process.env.VUE_APP_FOODSAFETYAPI_KEY1 + '/C004/json/1/1', 
  // 행정처분 결과
  adminDispos: 'http://openapi.foodsafetykorea.go.kr/api/' + process.env.VUE_APP_FOODSAFETYAPI_KEY2 + '/I2630/json/1/1', 
